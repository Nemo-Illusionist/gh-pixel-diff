...
В Safari то же самое можно сделать и без окна: Настройки → Расширения → GitHub
Pixel Diff → **Изменить сайты…** → поставить `viewscreen.githubusercontent.com`
в «Разрешить». Эта панель принадлежит Safari, и своей кнопки туда не добавит
никакое расширение.
