...
чужие workflow не запускают, так что ждать появления тега здесь нечему. По той
же причине release-please работает от личного токена: пул-реквест, созданный
`GITHUB_TOKEN`, не получит проверок, а `main` их требует.
