...
Расширение добавляет к режимам **2-up**, **Swipe** и **Onion Skin** ещё два.
**Pixel Diff** считает разницу попиксельно и сразу показывает тот фрагмент, где
она уместилась; **3-up** ставит рядом «до», «после» и разницу, каждый кадр
вписан по ширине.
...
- Встаёт в родной ряд режимов — отдельной панели нет.
- **3-up** показывает все три кадра сразу, в одной обрезке и одном масштабе:
  глаз сравнивает подобное с подобным.
...
- Переключатель «до / после / разница» под кадром: обе версии в том же масштабе
  и той же обрезке, что и разница. Выключается в окне расширения.
...
ни ваших репозиториев, ни сессии расширение не видит.
...
выкладывает их на страницу релизов.
