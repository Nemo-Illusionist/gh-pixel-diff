...
| Safari, macOS | Проект собирается конвертером Apple, схема macOS компилируется; включение в браузере — вручную |
| Safari, iOS | Не проверено: в системе не установлена платформа iOS, без неё схему не собрать |
